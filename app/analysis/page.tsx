  ...
  return (
    <div className="flex flex-col min-h-screen pb-32 pt-8">
      ...
      <header className="px-6 mb-8 flex items-center justify-between">
        ...
        <h1 className="text-xl font-serif font-bold text-slate-100 italic">
          読書分析
        </h1>
      ...
      {isLoading ? (
        <div className="flex-grow flex items-center justify-center opacity-40">
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="text-slate-400 font-serif italic">データを集計中...</p>
          </div>
        </div>
      ) : (
        <>
              ...
              <div className="card-premium p-6 flex flex-col items-center">
                <div className="w-full h-56 relative">
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                    <span className="text-3xl font-black text-slate-100 drop-shadow-lg">
                      {books.length}
                    </span>
                    <span className="text-[10px] text-slate-500 uppercase font-bold tracking-[0.2em] font-sans">
                      冊
                    </span>
                  </div>
                </div>
                ...
                <div className="w-full mt-6 grid grid-cols-2 gap-4">
                  {genreData.map((g, i) => (
                    <div key={i} className="flex items-center gap-2">
                      <div
                        className="w-3 h-3 rounded-full opacity-60 shadow-lg shadow-black/20"
          ...
          <section className="px-6 mb-20">
            <div className="card-premium bg-gradient-to-br from-navy-900 to-navy-950 border-slate-700/30 flex flex-col items-center text-center p-8 space-y-4 shadow-xl">
              ...
              <p className="text-slate-500 text-sm font-sans px-4">
                {doneCount > 0
                  ? `これまでに ${doneCount} 冊読了。次の目標を立てましょう。`
                  : "まずは1冊読了を目指しましょう"}
              </p>
            </div>
          </section>
